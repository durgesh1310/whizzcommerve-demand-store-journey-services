...
/*
    public String queryForSingleColumn(String sql,  Object  param) {
		return  jdbcTemplate.queryForObject(sql, String.class, param);
    	
    }
    public Integer updateEmail(String sql,  String  email, String updatedEmail, String mobile) {
		return  jdbcTemplate.update(sql,email, updatedEmail, mobile);
    	
    }
*/
	public Integer getCustomerId(String queryForCustomerId, String mobile) {
		try {
			return jdbcTemplate.queryForObject(queryForCustomerId,Integer.class, mobile);
		}catch (DataAccessException e) {
			return null;
		}
 	}

	public Integer getAddressId(String queryForAddressId, Integer customerId) {
		try {
	 		return jdbcTemplate.queryForObject(queryForAddressId,Integer.class,customerId);
		}catch (DataAccessException e) {
			return null;
		}
	}
    
    public Integer updateEmailByMobile(String sql,  String  email,  String mobile) {
    	try {
    		return jdbcTemplate.update(sql, email, mobile);
		}catch (DataAccessException e) {
			return 0;
		}
     	
    }
    public Integer updateMobileByEmail(String sql,  String  email,  String mobile) {
    	try {
    		return jdbcTemplate.update(sql, email, mobile);
		}catch (DataAccessException e) {
			return 0;
