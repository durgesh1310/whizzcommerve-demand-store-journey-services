package com.ouat.suggestionandsearch.logHttpReq;
...
/**
 * 
 * @author sourabh sourabh
 * @class: this is the general class to log the request coming from client because we cannot do
