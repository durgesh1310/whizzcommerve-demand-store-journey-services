...
public class ControllerHelper {
    /**
     * find whether one annotation is marked on method or class level included parent class, this
     * pattern is used to check whether one flag is declared on controller by interceptors
     *
     * @param handler the handler
     * @param annotationClass annotation class
     * @return annotation found, or null if not found
     */
    public static <A extends Annotation> A findMethodOrClassLevelAnnotation(Object handler,
