package com.ouat.cartService.exception;
...
import com.ouat.cartService.clients.EmailSMSServiceClient;
import com.ouat.cartService.clients.EmailSendRequest;
import com.ouat.cartService.response.DemandStoreAPIResponse;
import com.ouat.cartService.response.MessageDetail;
import com.ouat.cartService.response.MessageType;
...
public class GenericExceptionMapper {
	...
	public void sendEmail(Throwable exception) {
		if (env != null && env.equals("prod")) {
			...
			emailSMSServiceClient.sendEmail(new EmailSendRequest(toEmailId, "Exception in Cart Service " + env,
					"noreply@mail.taggd.com", "Cart Service", sw.toString()));
		}
	}
