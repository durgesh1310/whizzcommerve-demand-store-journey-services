package com.ouat.homepage.app.config;
...
import com.ouat.homepage.interceptor.SessionRequiredInterceptor;

@Configuration
@PropertySource("classpath:/${property.environment}/application.properties")
public class HomepageServiceConfig implements WebMvcConfigurer {
